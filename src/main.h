...
static const int64 MAX_MONEY = 84000000 * COIN; // Nullcoin: maximum of 840k coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 576 / 250; // Nullcoin: 576 blocks found a day. Priority cutoff is 1 nullcoin day / 250 bytes.
    }
...
public:
    ...
    {
        uint256 thash;
        Scrypt hash_scrypt(nBits);
        hash_scrypt.Target_2_1(BEGIN(nVersion), BEGIN(thash));
        hash_scrypt.CleanUp();
        return thash;
    }
