    ...
    ui(new Ui::VerifyMessageDialog)
{
    ...
    ui->lnAddress->setPlaceholderText(tr("Enter a Nullcoin address (e.g. Ler4HNAEfwYhBmGXcFP2Po1NpRUEiK8km2)"));
    ui->lnSig->setPlaceholderText(tr("Enter Nullcoin signature"));
#endif
